...
linkedInFormat = input("Please enter the format of the LinkedIn post? ").lower()

if linkedInFormat not in ["png", "gif"]:
    raise ValueError("Invalid format. Only PNG or GIF formats are accepted. ")



generateTextPrompt = "Generate a random linkedIn Poster about " + apiInput + " in GIF format"  if linkedInFormat == "gif" else "Generate a random linkedIn Poster about " + apiInput + " in PNG format"

print(generateTextPrompt)
